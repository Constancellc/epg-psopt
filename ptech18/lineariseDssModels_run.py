...
def main(fdr_i=5,linPoint=1.0,pCvr=0.8,method='fpl',saveModel=False):
    reload(lineariseDssModels)
    blm = lineariseDssModels.buildLinModel(FD=FD,fdr_i=fdr_i,linPoints=[linPoint],pCvr=pCvr,method=method,saveModel=saveModel)
    return blm
