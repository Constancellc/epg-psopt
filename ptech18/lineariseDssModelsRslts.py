...
# linPoints = [0.05,0.6,1.0]
linPoints = [0.10,0.3,0.6]
pCvrSet = [0.8]
feederSet = [18,'n4','n1','n10',17]
...
feeder = 18
linPoint = 0.20
self = main(feeder,pCvr=0.8,modelType='loadOnly',linPoint=linPoint)
self.loadQpSet()
self.loadQpSln('part','opCst')
self.showQpSln()

self.loadQpSln('part','hcGen')
self.showQpSln()

self.loadQpSln('part','hcLds')
self.showQpSln()
