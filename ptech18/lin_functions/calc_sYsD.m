    ...
    if D{i}==1
        if numel(B{i})>4
            if strcmp(B{i}(end-3),'.') && strcmp(B{i}(end-1),'.')
                ...
                ph2=str2num(B{i}(end));
                if ph1==1 && ph2==2
                    iD(idx{i,1}(1)) = iD(idx{i,1}(1)) + I{i}(1);
                    sD(idx{i,1}(1)) = sD(idx{i,1}(1)) + S{i}(1) + S{i}(2);
                elseif ph1==2 && ph2==3
                    iD(idx{i,1}(2)) = iD(idx{i,1}(2)) + I{i}(1);
                    sD(idx{i,1}(2)) = sD(idx{i,1}(2)) + S{i}(1) + S{i}(2);
                elseif ph1==3 && ph2==1
                    iD(idx{i,1}(3)) = iD(idx{i,1}(3)) + I{i}(1);
                    sD(idx{i,1}(3)) = sD(idx{i,1}(3)) + S{i}(1) + S{i}(2);
                end
            end
        else
            iD(idx{i,1}) = iD(idx{i,1}) + I{i}*exp(+1i*pi/6)/sqrt(3);
            sD(idx{i,1}) = sD(idx{i,1}) + S{i};
        end
    else
        if sum(B{i}=='.')>0
%         if numel(B{i})>4
                ph=str2num(B{i}(end));
                if ph==1
                    iY(idx{i,1}(1)) = iY(idx{i,1}(1)) + I{i}(1);
                    sY(idx{i,1}(1)) = sY(idx{i,1}(1)) + S{i}(1) + S{i}(2);
                elseif ph==2
                    iY(idx{i,1}(2)) = iY(idx{i,1}(2)) + I{i}(1);
                    sY(idx{i,1}(2)) = sY(idx{i,1}(2)) + S{i}(1) + S{i}(2);
                elseif ph==3
                    iY(idx{i,1}(3)) = iY(idx{i,1}(3)) + I{i}(1);
                    sY(idx{i,1}(3)) = sY(idx{i,1}(3)) + S{i}(1) + S{i}(2);
                end
        else
            iY(idx{i,1}) = iY(idx{i,1}) + I{i}(1:3);
            sY(idx{i,1}) = sY(idx{i,1}) + S{i}(1:3);
        end
